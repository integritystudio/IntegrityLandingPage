...
CREATE TABLE public.api_keys (
  ...
  tier USER-DEFINED NOT NULL DEFAULT 'new'::api_key_tier,
...
CREATE TABLE public.provisioning_jobs (
  ...
  source text NOT NULL CHECK (source = ANY (ARRAY['supabase_webhook'::text, 'stripe_webhook'::text, 'manual'::text, 'migration'::text])),
