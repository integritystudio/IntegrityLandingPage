...
**Priority:** P2 | **Source:** session 2026-08-07, CR14 step 5's data-handling audit
...
5. ✅ **Audited 2026-08-07 via git history + a live production cross-check.**
...
4. ➡️ **Carved out to [[CR32]] (2026-08-03)** — custom domain. Hostname now decided (`auth.integritystudio.ai`); **corrected 2026-08-07** — it is billing-gated (verified card required), not plan-gated as first read. See CR32.
