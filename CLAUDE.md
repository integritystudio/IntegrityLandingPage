...
- **CR25** ⚠️ Auth0 production-readiness: google-oauth2's shared dev-keys disabled ✅; MFA enforcement is a decision (would force all users to enrol); breached-password detection and custom domain are paid features; implicit grant, ROPC on the Management M2M, and log streams still open.
